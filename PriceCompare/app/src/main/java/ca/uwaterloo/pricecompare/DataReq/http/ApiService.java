...
import ca.uwaterloo.pricecompare.model.Store;
...
public interface ApiService {
  ...
  Observable<List<RecommendationCategory>> getRecommendationByCategory(
      @Path("category") int category);

  //--------------------Recommendation by category---------------
  @GET("/Display/querystore/{storename}")
  Observable<List<RecommendationStore>> getRecommendationByStore(
      @Path("storename") String storename);
