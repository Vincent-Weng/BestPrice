...
import ca.uwaterloo.pricecompare.model.RecommendationStore;
...
//---------------------Stock------------------------
  ...
  public static void createStore(Observer<List<Stock>> observer,
      String storename, String address, double latitude, double longitude, String city,
      double postcode) {
    ApiSubscribe(
        Api.getApiService().createStore(storename, address, latitude, longitude, city, postcode),
        observer);
  }
  ...
  public static void updateStore(Observer<List<Stock>> observer,
      ...
      double postcode) {
    ApiSubscribe(
        Api.getApiService().updateStore(storename, address, latitude, longitude, city, postcode),
        observer);
  }
